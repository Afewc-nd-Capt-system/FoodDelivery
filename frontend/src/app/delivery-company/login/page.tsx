...
export default function DeliveryCompanyLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await apiPost('/delivery-companies/login', { email, password });
      ...
      <div className="w-full max-w-md p-8">
        <div className="bg-white rounded-3xl shadow-lg p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold mb-2" style={{ color: '#1C1C1E' }}>Delivery Company Login</h1>
            <p className="text-sm" style={{ color: '#636366' }}>Sign in to manage your delivery company</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm" style={{ color: '#636366' }}>
              ...
              <Link href="/delivery-company/register" className="font-bold" style={{ color: '#E8621A' }}>
                Register
              </Link>
            </p>
          </div>
