...
export default function VendorPODConfigPage() {
  const { user, token, loading } = useAuthGuard('vendor')
  ...
  const handleSave = async () => {
    setSaving(true)
    try {
      await apiPut('/vendors/pod-config', config)
      setSaved(true)
    ...
    <div style={{ minHeight: '100vh', background: '#F5F5F7',
      ...
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#636366', marginBottom: '32px' }}>
          Configure pay-on-delivery options for your vendor business
        </p>
