...
import { ChefHat, Eye, EyeOff, Mail, Lock, AlertCircle, CheckCircle, Info } from 'lucide-react';
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!data.user.isVerified) {
        setError('Your vendor account is pending verification. Please wait for approval.');
        return;
      }
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm" style={{ color: '#A0A0A0' }}>
              Manage your pre-order business and reach more customers
            </p>
          </div>
          ...
          <Card className="p-8 bg-white shadow-xl">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="vendor@vibechops.com"
                    required
                  />
                </div>
              </div>
            ...
            <div className="mt-6 p-4 rounded-lg" style={{ backgroundColor: '#F0FDF4' }}>
              <div className="flex items-start gap-2">
                <Info size={16} className="mt-0.5" style={{ color: '#059669' }} />
                <div>
                  <p className="text-xs font-bold mb-1" style={{ color: '#1C1C1E' }}>
                    Vendor Benefits
                  </p>
                  <p className="text-xs" style={{ color: '#636366' }}>
                    • Pre-order system for better planning<br/>
                    • Access to thousands of hungry customers<br/>
                    • Flexible cooking schedule<br/>
                    • No delivery logistics required
                  </p>
                </div>
              </div>
            </div>
