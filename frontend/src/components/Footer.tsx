    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">VibeChops</h3>
            <p className="text-sm">
              Discover, Explore and Eat what you love. Order from the best restaurants and vendors in your area.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>Email: info@vibechops.com</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} VibeChops. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
